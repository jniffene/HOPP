...
def psh_flt_pvDetailsV2(A_total, z_max, h_o):
    ...
    print("Motor/ Generator Capacity = ", P_kW, "kW")
    ...
    plt.legend(["PV-G","PV-PSH","PSH-L","PV-L", "G-PSH", "G-L"])
    ...
    # print("G-PSH 2nd entry = ", P_grid2psh[1])
    # print("PV-PSH 2nd entry = ", P_pv2psh[1])
    # print("PV-G 2nd entry =")
    # print("PSH-L")
    # print("PV-L")
    # print("G-L")
    # print("PSH Volume 1st entry =", V_t[0]/V_max)
    # print("PSH Volume 2nd entry =", V_t[1]/V_max)

    return 

Results = psh_flt_pvDetailsV2(6469.5,8.8,2.6)
