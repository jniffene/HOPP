...
from psh_cost_fxnV2 import psh_costV2
from flt_pv_cost_fxnV2 import fltPVcostV2


def psh_flt_pvDetails(A_total, z_max, h_o, P_kW):
    ...
    psh_costs = psh_costV2(h_t, h_o, A_total, z_max)
...
Results = psh_flt_pvDetails(1849,2.6,21.6,73.2)
