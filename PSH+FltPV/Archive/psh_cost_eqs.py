...
# Inputs
Z_u_avg = 100 # ft; Avg. Upper Reservoir Depth (C8)
A_u = 80 # acres; Upper Reservoir Area (C9)
Z_L_avg = 100 # ft; Avg. Lower Resev. Depth (C11)
A_l = 80 # acres; Lower Resv. Area (C12)
L_c = 4000 # ft; Conveyance Length (C15)
T_cond = "Poor" # Tuneling Cond. (C17)
# H_nomMaxM = 100 # m; Nominal (max) Head 
H_nomMax = 328.08 # ft; Nominal (max) Head (C21)
t_gen = 10 # hr; Generating Time (C22)
Loc = "United States" # Location (C26)
A_acq = 100 # acres; Acerage to Aquire (C27)
...
H_G_min = Hmin_Hmax * H_nomMax # ft; min gross head
