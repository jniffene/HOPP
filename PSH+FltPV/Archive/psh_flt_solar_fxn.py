...
def psh_flt_pvFXN(A_total, z_max):
    ...
    P_cap = n_array * max(L_irr) * n*A_ca/1000
    ...
    psh_costs = psh_cost(h_t, h_o, A_total)
    ...
    return grid_req_frac, total_lcoe

# Results = psh_flt_pvFXN(1600,2)
